      ...
      <div className="z-10 flex h-full w-full flex-col-reverse items-center justify-center gap-4 md:flex-row">
        ...
        >
          ...
          <p className="max-w-[450px] text-center font-[500] leading-[160%] text-[#ffff]">
            ...
            <strong>Bradshaw</strong> invites you to experience a culinary
            journey unlike any other. From meticulously curated flavours to the
            finest hand-selected ingredients, every dish embodies our relentless
            pursuit of excellence. Step into a dining atmosphere where tradition
            meets innovation, and each bite tells a story of passion,
