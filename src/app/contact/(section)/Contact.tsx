  ...
  return (
    ...
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
            ...
            <div className="flex flex-col gap-8">
              <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <Link href={"https://g.co/kgs/85HavnW"} target="_blank">
                    <p className="font-poppins text-[#9C9E9F]">
                      122 Bradshaw Brow, Bolton <br /> BL2 3DD, United Kingdom
                    </p>
                  </Link>
                  <Link href={"https://g.co/kgs/85HavnW"} target="_blank">
              ...
              <div className="flex items-center justify-start gap-4">
                <Link
                  href={"https://www.instagram.com/rokabolton/"}
                  target="_blank"
                >
                  <Icons.instagram className="text-[#9C9E9F]" />
                </Link>
                <Link
                  href={"https://www.facebook.com/rokkamediterranean/"}
                  target="_blank"
                >
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2250.301359219068!2d-2.4053593999999996!3d53.6034471!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487ba6952d743c99%3A0xdf62f9c594e92775!2sBradshaw%20Bar%20%26%20Grill!5e1!3m2!1sen!2sin!4v1746863983088!5m2!1sen!2sin"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
